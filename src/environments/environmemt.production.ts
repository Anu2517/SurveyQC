export const environment = {
    ...
    isLogEnabled: true,
    envMode: "offline",
    witsmlUrl: window.location.protocol + "//" + '192.168.5.18'+ ":54502/api/v1/",
    baseUrl: window.location.protocol + "//" +'192.168.5.18' + ":54501/api/v1/",
    signalRUrl: window.location.protocol + "//" + '192.168.5.18'+ ":54501/ServerRealtimeService/",
